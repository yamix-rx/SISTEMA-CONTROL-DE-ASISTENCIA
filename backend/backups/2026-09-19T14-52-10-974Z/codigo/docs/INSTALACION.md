...
- Un navegador actual. Algunas pantallas cargan estilos, iconos y bibliotecas de exportación desde CDN; necesitan acceso a Internet para esos recursos.
...
| Una exportación de reportes no carga | Revisar la conexión a los CDN utilizados por esa pantalla. |
