...
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (1,1,'2026-09-14',NULL,NULL,'07:55:00','17:05:00',0,'9.17','presente','Asistencia puntual',NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (2,2,'2026-09-14',NULL,NULL,'08:00:00','17:00:00',0,'9.00','presente',NULL,NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (3,3,'2026-09-14',NULL,NULL,'09:22:00','15:10:00',7,'5.80','tardanza','Tráfico en óvalo Grau',NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (4,4,'2026-09-14',NULL,NULL,'08:48:00','14:30:00',3,'5.70','tardanza','Demora en transporte público',NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (5,5,'2026-09-14',NULL,NULL,'07:28:00','16:35:00',0,'9.12','presente',NULL,NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (6,6,'2026-09-14',NULL,NULL,'08:02:00','17:00:00',0,'8.97','presente',NULL,NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (7,3,'2026-09-13',NULL,NULL,'08:58:00','15:02:00',0,'6.07','presente',NULL,NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (8,3,'2026-09-12',NULL,NULL,'09:30:00','15:00:00',15,'5.50','tardanza','Trámite universitario',NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (9,3,'2026-09-11',NULL,NULL,'09:00:00','15:00:00',0,'6.00','presente',NULL,NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (10,4,'2026-09-13',NULL,NULL,'08:30:00','14:30:00',0,'6.00','presente',NULL,NULL);
INSERT INTO `asistencias` (`id`,`empleado_id`,`fecha`,`hora_programada_entrada`,`hora_programada_salida`,`hora_ingreso`,`hora_salida`,`minutos_tardanza`,`horas_trabajadas`,`estado`,`observacion`,`registrado_por_usuario_id`) VALUES (11,4,'2026-09-12',NULL,NULL,'08:30:00','14:30:00',0,'6.00','presente',NULL,NULL);
...
CREATE TABLE `historial_cambios` (
  ...
  `accion` enum('INSERT','UPDATE','DELETE','LOGIN','LOGIN_FALLIDO') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `permisos` (`id`,`empleado_id`,`tipo_permiso`,`fecha_inicio`,`fecha_fin`,`hora_desde`,`hora_hasta`,`motivo`,`observaciones`,`estado`,`archivo_sustento`) VALUES (1,3,'Médico','2026-09-10','2026-09-10','09:00:00','12:00:00','Cita médica odontológica Essalud',NULL,'Aprobado','cita_medica_carlos.pdf');
INSERT INTO `permisos` (`id`,`empleado_id`,`tipo_permiso`,`fecha_inicio`,`fecha_fin`,`hora_desde`,`hora_hasta`,`motivo`,`observaciones`,`estado`,`archivo_sustento`) VALUES (2,4,'Personal','2026-09-16','2026-09-16','10:00:00','13:00:00','Sustentación de avance académico en universidad',NULL,'Solicitado',NULL);
INSERT INTO `permisos` (`id`,`empleado_id`,`tipo_permiso`,`fecha_inicio`,`fecha_fin`,`hora_desde`,`hora_hasta`,`motivo`,`observaciones`,`estado`,`archivo_sustento`) VALUES (3,6,'Familiar','2026-09-07','2026-09-07','08:00:00','12:00:00','Atención médica a familiar directo',NULL,'Aprobado','sustento_familiar_rosa.pdf');
...
INSERT INTO `usuarios` (`id`,`empleado_id`,`rol_id`,`email`,`password`,`activo`) VALUES (1,1,1,'admin@silsan.pe','$2b$10$.AdgrtAZ5NfOzg1QTJFRtONv5znNrlHtlrYr/bdyu5xnlGdlFPMDa',1);
INSERT INTO `usuarios` (`id`,`empleado_id`,`rol_id`,`email`,`password`,`activo`) VALUES (2,2,2,'rrhh@silsan.pe','$2b$10$.AdgrtAZ5NfOzg1QTJFRtONv5znNrlHtlrYr/bdyu5xnlGdlFPMDa',1);
INSERT INTO `usuarios` (`id`,`empleado_id`,`rol_id`,`email`,`password`,`activo`) VALUES (3,3,3,'practicante@silsan.pe','$2b$10$.AdgrtAZ5NfOzg1QTJFRtONv5znNrlHtlrYr/bdyu5xnlGdlFPMDa',1);
