...
Las horas calculadas son la diferencia entre ingreso y salida: no hay una deducción automática de refrigerio. El horario aplicado a una asistencia registrada se conserva para no recalcular su historial al cambiar la programación futura. En registros antiguos sin programación guardada, puede ser necesario confirmar el horario original antes de recalcular una tardanza.
