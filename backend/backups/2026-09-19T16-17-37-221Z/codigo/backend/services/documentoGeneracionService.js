...
const PREDETERMINADAS = Object.freeze({
  ...
  carta: {
    ...
    cuerpo: 'A quien corresponda:\n\n{{empresa}} presenta a {{trabajador}}, identificado(a) con {{documento}}, quien desempeña el cargo de {{cargo}} en el área de {{area}}.\n\nSe extiende la presente para las gestiones correspondientes.\n\nFecha de emisión: {{fecha}}.\n\n\n________________________________\nFirma del responsable'
  },
  horas: {
    titulo: 'CONSTANCIA DE HORAS',
    cuerpo: 'Se deja constancia de que {{trabajador}}, identificado(a) con {{documento}}, registra {{horas}} horas en {{empresa}}, en el área de {{area}} y cargo de {{cargo}}.\n\nFecha de emisión: {{fecha}}.\n\n\n________________________________\nFirma del responsable'
  },
  trabajo: {
    titulo: 'CERTIFICADO DE TRABAJO',
    cuerpo: '{{empresa}} certifica que {{trabajador}}, identificado(a) con {{documento}}, figura en sus registros como trabajador(a) en el cargo de {{cargo}}, área de {{area}}, con fecha de ingreso {{fecha_ingreso}}.\n\nSe expide el presente documento a solicitud del interesado(a).\n\nFecha de emisión: {{fecha}}.\n\n\n________________________________\nFirma del responsable'
  }
});
