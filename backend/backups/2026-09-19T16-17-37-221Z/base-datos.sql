...
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (1,'DNI','70891234','Yenci Jose','Agreda Ramirez',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,2,2,'trabajador',NULL,'0.00','activo','2026-01-15',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (2,'DNI','45871290','Valeria Sofia','Mendoza Castro',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,1,'trabajador',NULL,'0.00','activo','2026-02-01',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (3,'DNI','73456789','Carlos Eduardo','Paredes Rios',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,2,3,'practicante','720.00','150.00','activo','2026-03-01',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (4,'DNI','72109845','Luciana Belen','Yamanaka Huamán',NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,4,6,'practicante','480.00','95.00','activo','2026-03-15',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (5,'DNI','41235678','Jorge Luis','Vargas Silva',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,3,4,'trabajador',NULL,'0.00','activo','2026-01-10',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (6,'DNI','46890123','Rosa Mercedes','Ramos Ruiz',NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,4,5,'trabajador',NULL,'0.00','activo','2026-02-15',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (7,'DNI','43567890','Melani Fiorella','López Rojas',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,5,7,'trabajador',NULL,'0.00','activo','2026-01-20',NULL,NULL,NULL);
INSERT INTO `empleados` (`id`,`tipo_documento`,`numero_documento`,`nombres`,`apellidos`,`foto_perfil`,`fecha_nacimiento`,`telefono`,`correo_personal`,`direccion`,`carrera`,`institucion_educativa`,`empresa_id`,`area_id`,`cargo_id`,`tipo_vinculo`,`horas_totales_asignadas`,`horas_completadas`,`estado`,`fecha_ingreso`,`fecha_finalizacion`,`observaciones_rrhh`,`puesto`) VALUES (8,'DNI','48901234','Daysi Paola','Reyes Padilla',NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,6,8,'trabajador',NULL,'0.00','activo','2026-02-01',NULL,NULL,NULL);
...
CREATE TABLE `practicante_detalles` (
  ...
  KEY `idx_practicante_vencimiento` (`fecha_vencimiento_convenio`),
