...
Administración y RRHH tienen accesos separados a **Practicantes**, **Permisos** y **Generar documentos**. Practicantes muestra únicamente esos vínculos; Permisos abre su gestión sin los bloques de asistencia y tardanzas; Generar documentos abre la selección de datos y mantiene las plantillas a mano.
...
**Cargo** se selecciona del catálogo del área. **Puesto** es un dato opcional separado, de hasta 150 caracteres, para describir la función concreta de la persona. Ambos se guardan y aparecen por separado en la ficha y en Mi panel.
...
En **Practicantes → Nuevo practicante** o **Editar ficha**, registra la **Fecha de vencimiento del convenio**. Puede dejarse sin registrar o borrarse al editar; si se completa, debe ser una fecha válida desde el ingreso. Esta fecha es independiente de la finalización de la ficha y de los contratos. Para practicantes activos cuyo convenio vence hoy o en los próximos 30 días, Administración e Inicio RRHH muestran una alerta con enlace a la ficha. El filtro de empresa también se aplica a estas alertas. Si cambia el vínculo de la persona, el convenio se conserva como historial, aunque la alerta corresponde solo a practicantes activos.
...
En **Permisos**, pulsa **Nuevo Permiso**. El mismo bloque sigue disponible dentro de **Asistencia**.
...
Abre **Generar documentos** desde el menú o utiliza **Generar documento** dentro de **Documentos**. Selecciona una de las plantillas:
...
| Convenio próximo a vencer | Fecha de vencimiento guardada en la ficha de un practicante activo, desde hoy hasta dentro de 30 días; funciona aunque no haya contratos registrados. |
| Contrato próximo a vencer | Contrato vigente registrado en Contratos con fecha de fin desde hoy hasta dentro de 30 días. |
...
El catálogo de **Contratos** incluye **Convenio de prácticas**, además de las modalidades preprofesional y profesional existentes. Registrar uno no sustituye la fecha de convenio de la ficha: cada alerta consulta su registro correspondiente.
